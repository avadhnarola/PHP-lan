...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="images/<?php echo $_SESSION['image'] ?>" alt="Profile" class="rounded-circle" style=" max-height: 40px;width: 40px;">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="viewInquiry.php">
          <i class="bi bi-eye"></i>
          <span>View Inquiry Data </span>
        </a>
      </li>
      <li class="nav-item">
